    ...
    <nav> 
        <ul> 
            ...
            if ($tipoUsuarioLogado === 'empresa'): 
                $primeiraOrgId = 1; 
                if (isset($_SESSION['user_bindings']) && !empty($_SESSION['user_bindings'])) { 
                    $primeiraOrgId = (int)$_SESSION['user_bindings'][0]['organization_id']; 
                } 
            ?> 
                <li style="background: rgba(52, 152, 219, 0.2); border-left: 4px solid #3498db;"> 
                    <a href="painel_b2b.php?org_id=<?php echo $primeiraOrgId; ?>">📋 Painel Prontuários</a> 
                </li> 
                <li><a href="novo_item_catalogo.php?org_id=<?php echo $primeiraOrgId; ?>">📦 Catálogo / Vitrine</a></li> 
                <li><a href="suporte_admin.php">🛠️ Suporte Técnico</a></li> 
