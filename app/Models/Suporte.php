...
class Suporte
{
    ...
    {
        $sql = "
            SELECT id, usuario_id, assunto, descricao, prioridade, status, criado_em, atualizado_em
            FROM suporte
    ...
    public function listarTodos(?string $status = null): array
    {
        $sql = "
            SELECT
                s.id, s.usuario_id, s.assunto, s.descricao, s.prioridade,
                s.status, s.criado_em, s.atualizado_em,
    ...
    public function listarRespostas(int $chamadoId): array
    {
        $sql = "
            SELECT
                r.id, r.chamado_id, r.usuario_id, r.resposta, r.criado_em,
