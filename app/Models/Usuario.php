   ...
   public function cadastrar(array $dados): bool
{
    ...
    {
        $sql = "SELECT
                    u.id, u.nome, u.sobrenome, u.email, u.latitude, u.longitude,
                    u.senha, u.telefone, u.cpf, u.foto, u.data_nascimento, u.genero,
                    u.status, u.ultimo_login, u.token_recuperacao, u.token_expira,
                    u.criado_em, u.atualizado_em, u.tipo_usuario, u.onboarding_concluido,
                    u.dois_fatores_ativo, u.dois_fatores_secret, u.dois_fatores_codigo,
                    u.dois_fatores_codigo_expira,
    ...
    {
        $sql = "SELECT
                    id, nome, sobrenome, email, latitude, longitude, senha,
                    telefone, cpf, foto, data_nascimento, genero, status,
                    ultimo_login, token_recuperacao, token_expira, criado_em,
                    atualizado_em, tipo_usuario, onboarding_concluido,
                    dois_fatores_ativo, dois_fatores_secret, dois_fatores_codigo,
                    dois_fatores_codigo_expira
                FROM usuarios
                WHERE id = :id
                LIMIT 1";
