...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    */
    ...
    if ($controller->atualizar($petId, $dados, $imagensExtras)) {
        Flash::sucesso("Pet atualizado com sucesso!");
        header('Location: ' . Url::pagina('meus_pets.php'));
        exit;
    }
    ...
    <div class="col-md-4">
        ...
        <div class="grupo-form">
            ...
            <?php if (!empty($pet["foto"]) && $pet["foto"] !== "sem-foto.png"): ?>
                <img
                    src="<?= htmlspecialchars(Foto::url($pet["foto"], 'pets')) ?>"
                    width="150"
                ...
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <?php foreach ($imagensExistentes as $imagem): ?>
                        <div style="position:relative; width:70px; height:70px;">
                            <img
                                src="<?= htmlspecialchars(Foto::url($imagem["arquivo"] ?? "", 'pets')) ?>"
                                width="70"
                                height="70"
