...
$pets = $controller->listarPorStatus("Para Adoção", $pagina, $porPagina);
$totalPets = $controller->contarPorStatus("Para Adoção");
                        ...
                        <tr style="border-bottom: 1px solid #eaeaea;">
                            ...
                            <td data-col="acoes" style="padding: 15px; text-align: center; white-space: nowrap;">
                                ...
                                <?php if (isset($_SESSION['usuario_id'])): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <a href="<?= Url::pagina('login.php') ?>" style="display: inline-block; background: #7f8c8d; color: white; text-decoration: none; padding: 6px 12px; border-radius: 4px; font-weight: bold; font-size: 13px; font-family: sans-serif;">Entrar pra adotar/favoritar</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
