...
if ($novoId !== false) {
    ...
    Flash::sucesso("Chamado aberto com sucesso! Nossa equipe vai te responder em breve.");
    header("Location: chamado.php?id=" . $novoId);
} else {
    Flash::erro("Preencha o assunto e a descrição pra abrir o chamado.");
    header('Location: ' . Url::pagina('novo_chamado.php'));
}
exit;
