...
<main class="conteudo">
    ...
    <div class="mb-3">
        <a href="cadastrar_produto.php?empresa_id=<?= $empresaId ?>" class="btn btn-success">➕ Cadastrar Novo Produto</a>
    </div>
        ...
        <?php if (count($produtos) > 0): ?>
            ...
            <?php foreach ($produtos as $produto): ?>
                ...
                <tr>
                    ...
                    <td>
                        <img
                            src="<?= !empty($produto['imagem_principal']) ? '../uploads/produtos/' . htmlspecialchars($produto['imagem_principal']) : '../assets/img/pets/sem-foto.png'; ?>"
                            width="60"
                            height="60"
