    ...
    if (!Csrf::validar($_POST["csrf_token"] ?? null)) {
        ...
        */
        ...
        if ($controller->atualizar($empresaId, $dados)) {
            ...
            Flash::sucesso("Empresa atualizada com sucesso!");
            header('Location: ' . Url::pagina('minhas_empresas.php'));
            exit;
    ...
    <div class="col-md-6">
        <div class="grupo-form">
            ...
            <?php if (!empty($empresa['logo'])): ?>
                <img src="<?= htmlspecialchars(Foto::url($empresa['logo'], 'empresas')) ?>" width="100" style="border-radius:8px; margin-bottom:8px; display:block;" alt="Logo atual">
            <?php endif; ?>
    ...
    <div class="col-md-6">
        <div class="grupo-form">
            ...
            <?php if (!empty($empresa['capa'])): ?>
                <img src="<?= htmlspecialchars(Foto::url($empresa['capa'], 'empresas')) ?>" width="150" style="border-radius:8px; margin-bottom:8px; display:block;" alt="Capa atual">
            <?php endif; ?>
        ...
        <div class="d-flex flex-wrap gap-2 mb-2">
            ...
            <?php foreach ($galeriaAtual as $imagem): ?>
                ...
                <div style="position:relative;">
                    ...
                    <img
                        src="<?= htmlspecialchars(Foto::url($imagem['imagem'], 'empresas')) ?>"
                        width="90"
                        height="90"
