...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // No máximo 8 tentativas por IP a cada 10 minutos; estourando isso,
    // bloqueia o IP por 30 minutos.
    $rateLimiter = new RateLimiter();

    if (!$rateLimiter->permitido('newsletter_descadastrar', 8, 10, 30)) {

        $mensagem = 'Muitas tentativas em pouco tempo. Tente novamente em '
            . $rateLimiter->minutosRestantes('newsletter_descadastrar') . ' minuto(s).';
        $tipoMensagem = 'danger';
