    ...
    <main class="container mb-5">
        ...
        <?php elseif (!$endereco): ?>
            ...
            <div class="alert alert-warning">
                ...
                <a href="<?= Url::pagina('endereco.php') ?>?voltar=checkout.php" class="alert-link">Cadastrar endereço</a>
            </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= Url::pagina('endereco.php') ?>?voltar=checkout.php" class="small">Alterar endereço</a>
                        </div>
                    </div>
