...
<main class="container" style="margin-top: 100px !important; margin-left: 280px !important; padding: 20px !important; display: block !important;"> 
    <div style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); width: 100%; max-width: 1200px; margin: 40px auto 0 auto !important; position: relative !important; display: block !important;"> 
        ...
        <p style="color: #7f8c8d; margin-bottom: 30px; font-family: sans-serif;">Aqui estão os pets que você cadastrou na plataforma.</p> 
                    ...
                    <?php foreach ($pets as $pet): ?> 
                        <tr style="border-bottom: 1px solid #eaeaea;"> 
                            ...
                            <td style="padding: 15px; color: #333;"> 
                                <?= htmlspecialchars($pet["status"] ?? 'Não informado'); ?> 
                            </td> 
                            <td style="padding: 15px; color: #777;"> 
                            ...
                            <td style="padding: 15px; text-align: center; white-space: nowrap;"> 
                                <a href="editar_pet.php?id=<?= (int) $pet['id']; ?>" style="display: inline-block; background: #3498db; color: white; text-decoration: none; padding: 6px 12px; border-radius: 4px; font-weight: bold; font-size: 13px; font-family: sans-serif;">✏️ Editar</a> 
                                <a href="excluir_pet.php?id=<?= (int) $pet['id']; ?>" style="display: inline-block; background: #e74c3c; color: white; text-decoration: none; padding: 6px 12px; border-radius: 4px; font-weight: bold; font-size: 13px; font-family: sans-serif; margin-left: 5px;">❌ Excluir</a> 
                            </td> 
                        </tr> 
                    <?php endforeach; ?> 
                <?php else: ?> 
                    <tr> 
                        <td colspan="7" style="padding: 30px; text-align: center; color: #95a5a6; font-style: italic;">Você ainda não cadastrou nenhum pet. 🐾</td> 
                    </tr> 
                <?php endif; ?> 
            </tbody> 
        </table> 
