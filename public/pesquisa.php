...
<body style="padding-top:38px;">
    ...
    <header class="border-bottom py-3 mb-4">
        <div class="container d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <a href="<?= Url::pagina('empresas.php') ?>" class="btn btn-outline-primary">
            ...
            <div class="row g-3 mb-4">
                <?php foreach ($topicos as $topico): ?>
                    ...
                    $destinoTopico = match ((int) $topico['id']) {
                        8 => 'buscar_pets.php',
                        9 => 'produtos.php',
                        default => Url::pagina('empresas.php') . '?categoria_id=' . (int) $topico['id']
                    };
                    ?>
                    <div class="col-md-4">
                ...
                <?php foreach ($empresas as $empresa): ?>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card empresa-card h-100 shadow-sm">
                            <a href="<?= Url::pagina('empresa.php') ?>?id=<?= (int) $empresa['id'] ?>">
                            ...
                            <div class="card-body">
                                ...
                                <h4>
                                    <a href="<?= Url::pagina('empresa.php') ?>?id=<?= (int) $empresa['id'] ?>" class="text-decoration-none text-dark">
                            ...
                            <div class="card-footer bg-white">
                                <a href="<?= Url::pagina('empresa.php') ?>?id=<?= (int) $empresa['id'] ?>" class="btn btn-outline-primary w-100">
                                    <i class="bi bi-eye"></i>
                                    Ver Perfil
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                ...
                                <h3 class="h5">
                                    <a href="<?= Url::pagina('produto.php') ?>?id=<?= (int) $produto['id'] ?>" class="text-decoration-none text-dark">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                ...
                                <h3 class="h5">
                                    <a href="<?= Url::pagina('pet.php') ?>?id=<?= (int) $pet['id'] ?>" class="text-decoration-none text-dark">
